...
we have used [https://dashboard.emailjs.com/admin](https://dashboard.emailjs.com/admin) for email based transaction. Ofcourse its free now but can be used for enterprises editions also.
