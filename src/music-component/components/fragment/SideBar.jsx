    ...
    return (
        <aside style={useStyle.component} className={"aside-bar"}>
            <div className="aside-bar-container">
                ...
                <SideBarOptions className={"lib-sub"} Icon={HomeOutlined} href={"/music-home"} title={"Home"} />
                <SideBarOptions className={"lib-sub"} Icon={ExploreOutlined} href={"/music-home/about"}  title={"About"}/>
                <SideBarOptions className={"lib-sub"} Icon={SearchOutlined} href={"/music-home/search"}  title={"Search"}/>
